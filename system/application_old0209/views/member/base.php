...
<div id="ui" class="ui">
 ...
 -->
            ...
            <ul class="nav navbar-nav navbar-right ">
                 ...
                 <?php }else {?>
                     <li class="product-wallet-balance">
                        <a><i class="fas fa-wallet"></i> Product Wallet: <i class="fa fa-rupee"></i>
                ...
                <?php } ?>
                 ...
                 <?php if (config_item('enable_repurchase') == "Yes") { ?>
                    ...
                    <a href="<?php echo site_url('cart/pre_checkout') ?>"
                       class="btn cart hidden-xs" style="border-radius:0px"><i class="fas fa-shopping-cart"></i> Cart: <?php echo count($this->cart->contents()) ?> </a>                             
                   </li>
                <?php } ?>
    ...
    <aside id="aside" class="ui-aside">
        ...
        <ul class="nav" ui-nav>
            <li class="active welcome_box">
                         ...
                         <h4 style="color:#00287b;;"> <i class="fa fa-trophy"></i>
                       <?php 
            ...
            <?php if (config_item('enable_repurchase') == "Yes") { ?>
                <li class="left-menu">
                    <a href=""><i class="fa fa-shopping-cart"></i><span>Shop</span><i
                                class="fa fa-angle-right pull-right"></i></a>
                    <ul class="nav nav-sub">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row w-states">
                                    ...
                                    <div class="col-md-2 col-xs-6">
                                        <a href="#"
                                           class="btn purple-btn btn-block">
                                            <span class="value" id="dw"><?php echo $this->db_model->count_all('member', array('sponsor' => $this->session->user_id)); ?></span>
                               ...
                               <?php if (config_item('enable_repurchase') == "Yes") { ?>
                               <br>
                               <div class="row w-states repurclass">
                                                    ...
                                                    <a href="#"
                                                       class="btn purple-btn btn-block ">
                                                         <span class="value" style="font-size: 18px;"><i class="fa fa-rupee"></i>  <?php $data = $this->db_model->sum('amount', 'earning', array(
                                                            ...
                                                            ?></span>
                                                        <span class="info">PENDING R EARNINGS</span>
                                                    </a>
                                                </div>
                                                   <div class="col-md-3 col-xs-6">
                                                       <a href="#"
                                                ...
                                                <div class="col-md-3 col-xs-6">
                                                        <a href="#"
                                                       class="btn purple-btn btn-block ">
                                                        <span class="value" style="font-size: 18px;">Coming Soon</span>
                                                        <span class="info">OTHER EARNINGS</span>
                                                        </a>
                                                </div>
                                            </div>  
                                ...
                                <div class="panel-group">
                                  <div class="panel panel-default">
                                    <div class="panel-heading">
                                      <span>
                                        <a data-toggle="collapse" href="#collapse1">RE-PURCHASE EARNING <i class="fa fa-angle-double-down"></i></a>
                                      </span>
                                    </div>
                                ...
                                <div id="google_translate_element"></div>
                                 ...
                                 <script type="text/javascript">
                                    function googleTranslateElementInit() {
                                      new google.translate.TranslateElement({pageLanguage: 'en', includedLanguages: 'ar,en,es,jv,ko,pa,pt,fr,ru,zh-CN', layout: google.translate.TranslateElement.InlineLayout.SIMPLE, autoDisplay: false}, 'google_translate_element');
                                    }
                                    </script>
                                <script type="text/javascript"
