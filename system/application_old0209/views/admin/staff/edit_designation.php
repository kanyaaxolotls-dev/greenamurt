    ...
    <div class="col-sm-12">
        ...
        <p>
            ...
            <input type="checkbox" value="1" <?php if ($perms['epin'] == "1") {
             ...
             <ul>
                <li> <input class="custom-control-input" value="1" <?php if ($perms['createEpin'] == "1") {
                echo 'checked'; } ?> id="createEpin" name="createEpin" type="checkbox">
                    <label class="custom-control-label" for="createEpin">Create e-PIN </label>
                </li>
                <li> <input class="custom-control-input" value="1" <?php if ($perms['editEpin'] == "1") {
                echo 'checked';} ?> id="editEpin" name="editEpin" type="checkbox">
                    <label class="custom-control-label" for="editEpin">Edit e-PIN </label>
                </li>
                 <li> <input class="custom-control-input" value="1" <?php if ($perms['transferEpin'] == "1") {
                echo 'checked';} ?> id="transferEpin" name="transferEpin" type="checkbox">
                    <label class="custom-control-label" for="transferEpin">Transfer e-PIN </label>
                </li>
                <li> <input class="custom-control-input" value="1" <?php if ($perms['viewEpin'] == "1") {
                echo 'checked'; } ?> id="viewEpin" name="viewEpin" type="checkbox">
                    <label class="custom-control-label" for="viewEpin">View e-PIN </label>
                </li>
