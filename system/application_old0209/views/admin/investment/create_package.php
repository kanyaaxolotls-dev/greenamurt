        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                ...
                <input type="text" class="form-control" placeholder="Comma separate each sponsor level income. eg: 12,3,4"
                       name="sp_level_income" value="<?php echo set_value('sp_level_income') ?>">
            </div>
            ...
            <div class="col-sm-6">
                <label>Earning  Rule - Working Days? </label>
				<?php $is_working_days = set_value('is_working_days')==0?0:1;?>
                ...
                <label>Payout (In Days)</label>
				 <select name="payout_cycle" class="form-control">
				   <?php foreach($payout_cycle_dropdown as $pc) { ?>
                    <option  value="<?php echo $pc; ?>" <?php if(set_value('payout_cycle')==$pc): echo 'selected="selected"'; endif;?>  ><?php echo $pc; ?></option>
				   <?php } ?>
                </select>
            </div>
            <!--- END ----------------->
