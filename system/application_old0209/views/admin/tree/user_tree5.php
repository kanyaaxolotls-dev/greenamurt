            ...
            <div class="hr_divider" style="text-align: center"><p>&nbsp;</p>
                <div class="table-responsive" style="overflow-x: auto; text-align: left">
                    <table align="center" class="table" style="max-width: 500px">
                        <tr>
                            <td colspan="3" class="alert alert-warning"> <?php $U = $this->plan_model->create_tree5($top_id);
                                echo $U['data'] ?></td>
                        </tr>
                        <?php
            ...
            <div class="col-sm-12">
                <div class="table-responsive">
                    <table class="table table-borderless">
                        <tbody>
                        <tr>
                            <td colspan="8" align="center"><?php $U = $this->plan_model->create_tree5($top_id);
                        ...
                        <tr>
                            <td colspan="2"
                                align="center"><?php $A_1 = $this->plan_model->create_tree5($A['A'], $A['id'], 'A');
                            ...
                            <td colspan="2"
                                align="center"><?php $B_1 = $this->plan_model->create_tree5($B['A'], $B['id'], 'A');
                        ...
                        <tr>
                            <td align="left"><?php $A1_1 = $this->plan_model->create_tree5($A_1['A'], $A_1['id'], 'A');
                                echo $A1_1['data'] ?></td>
                            <td align="right"><?php $A1_2 = $this->plan_model->create_tree5($A_1['B'], $A_1['id'], 'B');
                                echo $A1_2['data'] ?></td>
                            <td align="left"><?php $A2_1 = $this->plan_model->create_tree5($A_2['A'], $A_2['id'], 'A');
                                echo $A2_1['data'] ?></td>
                            <td align="right"><?php $A2_2 = $this->plan_model->create_tree5($A_2['B'], $A_2['id'], 'B');
                                echo $A2_2['data'] ?></td>
                            <td align="left"><?php $B1_1 = $this->plan_model->create_tree5($B_1['A'], $B_1['id'], 'A');
                                echo $B1_1['data'] ?></td>
                            <td align="right"><?php $B1_2 = $this->plan_model->create_tree5($B_1['B'], $B_1['id'], 'B');
                                echo $B1_2['data'] ?></td>
                            <td align="left"><?php $B2_1 = $this->plan_model->create_tree5($B_2['A'], $B_2['id'], 'A');
                                echo $B2_1['data'] ?></td>
                            <td align="right"><?php $B2_2 = $this->plan_model->create_tree5($B_2['B'], $B_2['id'], 'B');
                                echo $B2_2['data'] ?></td>
                        </tr>
                        </tbody>
                    </table>
