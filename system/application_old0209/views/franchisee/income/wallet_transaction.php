              ...
              <table class="table align-items-center table-flush" id="example">
                <thead class="thead-light">
                    ...
                    <tr>
                        ...
                        <td class="text-<?= $clr ?>"><?php echo $e['type']; ?></td>
                        <td class="text-dark"><a target="_blank" href="<?= base_url('franchisee/order_view/'.$e['orderid']); ?>">#<?php echo $e['orderid']; ?></a></td>
                        <td class="text-dark"><?php echo $e['created_at']; ?></td>
                    </tr>
                    <?php } ?>
                </table>
            </div>
