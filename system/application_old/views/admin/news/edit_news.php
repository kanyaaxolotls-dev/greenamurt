...
<?php // echo form_open('news/edit/'. $news['id'], array("class" => "form-horizontal")); ?>
   <?php echo form_open_multipart('news/edit/'. $news['id'], array("class" => "form-horizontal")); ?>

<div class="form-group">
    <label for="news_title" class="form-control-label">Title<span class="text-danger">*</span></label>
    <div class="col-md-8">
        <input type="text" name="news_title" value="<?php echo set_value('news_title'); ?>" class="form-control"
               id="news_title"/>
...
<div class="form-group">
    ...
    <div class="col-md-8">
        <textarea name="news_details" class="form-control" id="news_details"><?php echo set_value('news_details'); ?></textarea>
