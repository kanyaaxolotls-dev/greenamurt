    ...
    <table class="table table-striped table-bordered">
        ...
        foreach ($result as $e) { ?>
            <tr>
                ...
                <td><a href="<?php echo site_url('coupon/edit-cat/' . $e->id); ?>"class="btn btn-info btn-sm">Edit</a>
                <a onclick="return confirm('Are you sure you want to delete this category ?')" href="<?php echo site_url('coupon/remove-cat/' . $e->id); ?>" class="btn btn-danger btn-sm">Delete</a>
                </td>
            </tr>
        <?php } ?>
    </table>
