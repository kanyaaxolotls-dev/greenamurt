                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                       ...
                       <div class="input-group-prepend">
                        ...
                        <input required type="text" class="form-control form-control-alternative" id="name" name="name" placeholder="Your name"
                               placeholder="Mr Xyz">
                        </div>
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="input-group input-group-alternative mb-3">
                         ...
                         <input type="text" onchange="get_user_name('#sponsor', '#spn_res')" required class="form-control form-control-alternative"
                    ...
                    <div class="form-group col-sm-6">
                       ...
                       <!--  <input type="text" class="form-control" value="<?php echo set_value('phone') ?>" id="phone" name="phone" placeholder="9xxxxxxxxx"> -->
                        ...
                        <input type="text" required Maxlength="10" class="form-control form-control-alternative" id="phone" name="phone" placeholder="Phone Number i.e.999999999">
                    </div>
                ...
                <?php if (config_item('leg') !== "1" && config_item('show_placement_id') == "Yes" && config_item('autopool_registration') == "No") {
                        ...
                        <div class="form-group col-sm-6">
                           <!--  <label for="position" class="control-label">Placement ID<span
                            ...
                            <input type="text" class="form-control form-control-alternative" onchange="get_user_name('#position', '#psn_res')"
                                   ...
                                   name="position" id="position" placeholder="Sign-up. Under/ Placement">
                                   <small id="psn_res" style="color: red;"></small>
                        </div>
                    ...
                    <?php }
                        ...
                        <div class="form-group col-sm-6" id="e_pin">
                            ...
                            <input required type="text" value="<?php if (trim($this->uri->segment(3)) == "epin") {
                                echo set_value('epin', $this->uri->segment(4));
                            } ?>" class="form-control" id="epin"
                                   name="epin" placeholder="ePin">
                        </div>
                    <?php }
                          ...
                          <!--   <label for="address_1" class="control-label">Address Line 1<span style="color: red;">*</span></label> -->
                            <!-- <input type="text" class="form-control" value="<?php echo set_value('address_1') ?>" id="address_1"
                                   name="address_1"> -->
                                    ...
                                    <input required type="text" class="form-control form-control-alternative" placeholder="Address i.e. India" id="address_1"
                                   name="address_1">
                        </div>
                        <div class="form-group col-sm-6">
                              <!--   <label for="address_2" class="control-label">Address Line 2</label> -->
                                <input type="text" class="form-control form-control-alternative" value="<?php echo set_value('address_2') ?>" id="address_2"  placeholder="Address2 i.e.USA"
                                       name="address_2">
                        </div>
                        <!-- <div class="form-group col-sm-6">
