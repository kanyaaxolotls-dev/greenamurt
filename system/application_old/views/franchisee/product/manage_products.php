                ...
                <thead class="thead-light">
                    ...
                    foreach ($prod as $e) { ?> 
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo site_url('franchisee/view_prod/' . $e['id']); ?>"><img src="https://img.icons8.com/color/20/000000/visible.png"></a>
                                <a href="<?php echo site_url('franchisee/edit/' . $e['id']); ?>"><img src="https://img.icons8.com/cotton/20/000000/edit.png"></a>
                                <a onclick="return confirm('Are you sure you want to delete this Product ?')"
                                   href="<?php echo site_url('franchisee/remove/' . $e['id']); ?>"
