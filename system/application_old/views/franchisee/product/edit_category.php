...
<div class="card-body">
             ...
             <?php
              $data     = $this->db_model->select_multi('*', 'product_categories', array('id' => $this->uri->segment(3)));
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6"> 
                        <div class="form-group"><br><br>
                            <input type="submit" class="btn btn-success btn-block" value="Update" onclick="this.value='Updating..'"></div>
                    </div>
                </div>
