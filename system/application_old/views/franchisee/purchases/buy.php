                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-md-6">
                                <div class="card">
                                    <div class="card-body">
                                        <form enctype="multipart/form-data" class="needs-validation" action="<?php echo base_url('franchisee/checkout2')?>" method="POST" novalidate>
                                            <div class="mb-3">
                                                <p class="text-dark h5 text-center">
                                                    WALLET BALANCE :
                                                    <span id="upiId">
                                                        <?= $this->db_model->select('wallet', 'franchisee', array('id' => $this->session->fran_id)) ?>
                                                    </span>
                                                </p>
                                            </div>
                    
                                            <div class="text-center"> <!-- Button centered here -->
                                                <input type="submit" id="send_request_btn" class="btn btn-primary" value="Purchase Now">
                                            </div>
