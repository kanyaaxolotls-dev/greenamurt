  ...
  <div class="row about">
    <div class="col-md-offset-0 col-md-12">
      ...
      <p class="text-left about-desc">
        <h2>Privacy Policy of <?php echo config_item('company_name') ?></h2><br>
  
          <?php echo config_item('company_name') ?> operates the Website Name website, which provides the SERVICE.
...
<br><br><h2>Changes to This Privacy Policy
</h2><br>
