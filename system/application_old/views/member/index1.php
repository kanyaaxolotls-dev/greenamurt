  ...
  <?php  
    ...
    <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-purple" id="sidenav-main">
      ...
      <div class="sidenav-header " >
        <a class="navbar-brand pt-0" href="<?php echo base_url('../index.php') ?>">
        <img src="<?php echo base_url('uploads/logo.png') ?>" class="navbar-brand-img img-thumbnail" alt="...">
        </a>
      </div>
      ...
      <!-- Collapse -->
          ...
          <div class="row">
            <div class="col-6 collapse-brand">
              <a href="<?php echo base_url('member/index') ?>">
                <img src="<?php echo base_url('uploads/logo.png') ?>" class="img img-thumbnail">
              </a>
            </div>
       ...
       <!--     <li class="nav-item">
          ...
          <?php if (config_item('enable_upgrade') == "Yes"){ ?>
             <?php $data = $this->db_model->select('signup_package', 'member', array('id' => $this->session->user_id));
               if ($data > "1"){   ?>

              <li class="nav-item">
                <a class="nav-link " href="<?php echo site_url('member/setup_company') ?>">
                  <i class="ni ni-pin-3 text-orange"></i> Set Up Your Company
                </a>
              </li>
            <?php } } ?>
          <!-- Epin Menu -->
...
>              <i class="ni ni-single-02 text-primary"></i> Genealogy Lookup<b class="caret"></b></a>
                <div class="navbar-nav collapse" id="geneology" aria-expanded="false" >
                    <ul class="nav">
                      ...
                      <?php if($config['plantype'] = "Single Leg with Autopool") { ?>
                     <!--  <li class="nav-item">
                        <a class="nav-link " href="<?php echo site_url('tree/autopool_team') ?>">
                         <i class="ni ni-planet text-white"></i> Auto Pool Team
                        </a> 
                      </li> -->
                ...
                <a class="nav-link " data-toggle="collapse" href="#fund" aria-expanded="false" class="collapsed">
                  <i class="ni ni-bell-55 text-primary"></i>Fund Deposit<b class="caret"></b></a>
                    <div class="navbar-nav collapse" id="fund" aria-expanded="false" >
                        <ul class="nav">
                          <li class="nav-item">
                            <a class="nav-link " href="<?php echo site_url('member/deposit') ?>">
 ...
 Add Money</a>
              ...
              <div class="media align-items-center">
                <span class="avatar avatar-sm rounded-circle">
                  ...
                  <img alt="Photo" src="<?php 
                      echo base_url('uploads/'.$prof_pic)?>">
                </span>
    ...
    $toppp = $this->db_model->select('topup', 'member', array('id' => $this->session->user_id));
      ...
      <?php }else{ ?>
         <div class="header pb-8 pt-5 pt-md-8" style="background-color: red;">
      <?php } ?>
      ...
      <div class="container-fluid">
        ...
        <div class="row align-items-center py-1">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Hi, <?php echo $this->session->name ?></h6>
            ...
            <div class="col-xl-3 col-6 col-md-6">
              <div class="card card-stats mb-4 mb-xl-4 dashboard-card">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-12">
                      <h5 class="card-title text-uppercase text-white mb-0">Total Profit</h5>
             ...
             <div class="col-xl-3 col-6 col-md-6">
              <div class="card card-stats mb-4 mb-xl-4 dashboard-card">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-12">
                      <h5 class="card-title text-uppercase text-white mb-0">Received</h5>
                  ...
                  <div class="row">
                    <div class="col-12">
                       <span class="h2 font-weight-bold mb-0 text-white"> <?php $data = $this->db_model->sum('amount', 'withdraw_request', array(
                                                    'userid' => $this->session->user_id,
                                                    'status' => 'Paid', ));if ($data == "") {
                                                     echo  '<i class="fa fa-inr"></i> '.'0'; } else { echo '<i class="fa fa-inr"></i> '.$data;}
                                                ?></span>
                    </div>
                  </div>
                <!--   <p class="mt-3 mb-0 text-sm">
             ...
             <div class="col-xl-3 col-6 col-md-6">
              <div class="card card-stats mb-4 mb-xl-0 dashboard-card">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-12">
                      <h5 class="card-title text-uppercase text-white mb-0">My Investment</h5>
                   ...
                   <div class="row">
                    <div class="col-12">
                       <span class="h2 font-weight-bold mb-0 text-white"> 
                         <?php $data = $this->db_model->sum('amount', 'investments', array(
                                                    'userid' => $this->session->user_id, ));
                          // $wallet_bal = $this->db_model->sum('balance', 'wallet', array(
                          //                           'userid' => $this->session->user_id));

                          // $paid_payout = $this->db_model->sum('amount', 'withdraw_request', array(
                          //                           'userid' => $this->session->user_id));

                          // $total_pending = $data - $paid_payout - $wallet_bal;
             ...
             <div class="col-xl-3 col-6 col-md-6">
              <div class="card card-stats mb-4 mb-xl-0 dashboard-card">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-12">
                      <h5 class="card-title text-uppercase text-white mb-0">Team Investment</h5>
                   ...
                   <div class="row">
                    <div class="col-12">
                       <span class="h2 font-weight-bold mb-0 text-white"> 
                        <?php $data = $this->db_model->select('total_a_investment', 'member', array(
             ...
             <div class="col-xl-3 col-6 col-md-6">
              <div class="card card-stats mb-4 mb-xl-0 dashboard-card">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-12">
                      <h5 class="card-title text-uppercase text-white mb-0">Profit</h5>
             ...
             <div class="col-xl-3 col-6 col-md-6">
              <div class="card card-stats mb-4 mb-xl-0 dashboard-card">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-12">
                      <?php $roi = $this->db_model->sum('amount', 'earning', array(
                                                        'userid'    => $this->session->user_id,
                                                        'type' => 'Sponsor Level Inc','status'=>'Pending')) ; ?>
                      <h5 class="card-title text-uppercase text-white mb-0">Sp.Level Income <span class="text-red"></span></h5>
                   ...
                   <div class="row">
                    <div class="col-12">
                       ...
                       <?php 
                            ...
                            'position' => $this->session->user_id),array(
                            'topup' => 3000));
                                 if ($total == "") {
                                         //echo config_item('currency') . '0';
                                             echo '0';
            ...
            <div class="col-xl-3 col-6 col-md-6">
              <div class="card card-stats mb-4 mb-xl-0 dashboard-card">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-12">
                      <h5 class="card-title text-uppercase text-white mb-0">Total Team</h5>
                   ...
                   <div class="row">
                    <div class="col-12">
                       <span class="h2 font-weight-bold mb-0 text-white"> 
                         <?php 
                                 $total = $this->db_model->select_multi('total_a,total_b', 'member', array(
                                                        'id'    => $this->session->user_id)) ;
                                 if ($total == "") {
                                                    //echo config_item('currency') . '0';
                                                    echo '0';
                                                   ...
                                                   // echo config_item('currency') . $data;
                                                     echo $total->total_a + $total->total_b;
                                                }
                          ?>
                        </span>
                 ...
                 <!--  <p class="mt-3 mb-0 text-sm">
                    <span></span>n class="text-success mr-2"><i class="fa fa-arrow-up"></i> 3.48%</span>
                    <span class="text-nowrap">Since last month</span>
                  </p> -->
                </div>
              </div>
            ...
            <div class="col-xl-3 col-6 col-md-6">
              <div class="card card-stats mb-4 mb-xl-0 dashboard-card">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-12">
                      <h5 class="card-title text-uppercase text-white mb-0">Membership</h5>
                   ...
                   <div class="row">
                    <div class="col-12">
                       <span class="h2 font-weight-bold mb-0 text-white"> 
                         <?php 
                               $topup=$this->db_model->select('topup', 'member', array('id'=> $this->session->user_id));

                               if($topup==600){
                                $poolname="Normal";}else if($topup==3000){
                                $poolname="Premium Pool";}else if($topup==20000){$poolname="Silver Pool";}else if($topup==100000){
                                $poolname="Gold Pool";}else if($topup==500000){$poolname="Super Gold";}else if($topup==2500000){
                                $poolname="Diamond Pool";}else{$poolname="No Active";}
                                echo $poolname;
   ...
   <!--    <div class="row">
      ...
      <div class="row mt-3">
        <div class="col-xl-8 mb-5 mb-xl-0 ">
          <div class="card shadow">
            ...
            <br>
            <?php
                  if (config_item('enable_topup') == "No" && $this->db_model->select('topup', 'member', array('id' => $this->session->user_id)) <= '0') {
                                  ...
                                  <tbody>
                                   <?php
                                            $this->db->select('id,userid,type, amount,date,status')
                                                     ->where('userid', $this->session->user_id)->order_by('id', 'ASC')
          ...
          <div class="card shadow">
            ...
            <div class="card-body">
               <?php echo form_open('member/topup') ?> 
                                    ...
                                    <label><input type="checkbox"  id="checktopup" name="checktopup" onclick="enableDisable(this.checked, 'topup')" value="Yes" checked> Activate from wallet</label>
                                  
                                  <!--   <label>Or Enter e-PIN to Upgrade</label>
                                    <input class="form-control" type="text"
                                           name="topup" id="topup"><br/> -->
    ...
    <?php }} ?>
      ...
      <footer class="footer">
        <div class="align-items-center justify-content-xl-between">
          <div class="col-xl-6">
            <div class="copyright text-xl-left text-blue">
              &copy; 2020 <a href="www.<?php echo $_SERVER['HTTP_HOST']?>" class="font-weight-bold ml-1" target="_blank"><?php echo config_item('company_name') ?></a>
            </div>
          </div>
          <div class="col-xl-6">
            <ul class="nav nav-footer justify-content-center justify-content-xl-end">
             <!--  <li class="nav-item">
                <a href="https://www.axolotls.in" class="nav-link" target="_blank">Home</a>
              </li> -->
              <!-- <li class="nav-item">
                <a href="www.axolotls.in/about.php" class="nav-link" target="_blank">About Us</a>
              </li>
              <li class="nav-item">
                <a href="www.axolotls.in/Support" class="nav-link" target="_blank">Blog</a>
              </li> -->
             <!--  <li class="nav-item">
    ...
    <div class="sticky-menu bg-purple">
        <div class="container">
          <span class="text-white">
            <div class="left"><a href="<?php echo site_url('site/register/A/') ?>" class="btn btn-purple">AddMember</a></div>
            <div class="centre"><a href="<?php echo site_url('tree/leveldata') ?>" class="btn btn-purple">Level</a></div>
