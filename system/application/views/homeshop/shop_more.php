...
<div class="container">
  <div class="row">
    <div id="column-left" class="col-sm-3 hidden-xs column-left">
        ...
        <div class="category_block">
          ...
          <?php
                ...
                foreach ($categories as $e) { ?>
                   <li><a href="<?php echo site_url('homeshop/shop_more/' . $e->id) ?>"   class="parent"  ><?php echo $e->cat_name ?></a>  </li>
      ...
      <div class="banner left-sidebar-widget"> <a href="#"><img src="<?php echo base_url('axxets/shop/image/banners/LeftBanner.jpg')?>" alt="Left Banner" class="img-responsive" /></a> </div>
          ...
          <li class="product-layout">
            ...
            <div class="col-xs-8">
              <div class="caption product-detail">
                ...
                <p class="price product-price"> <span class="price-new">INR 0.00</span> <span class="price-old">$272.00</span> </p>
                    ...
                    <ul class="button-group">
                      ...
                      <li>
                        <!-- <button type="button" class="addtocart-btn" title="Add to Cart"  > Add to Cart </button> -->
                          <a href="<?php echo site_url('homeshop/buy_2/' . $e->id) ?>" class="addtocart-btn" role="button">Add to Cart</a>
