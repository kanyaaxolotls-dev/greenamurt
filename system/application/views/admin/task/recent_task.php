    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modal-title-default">Are you sure</h5>
            ...
            <div class="modal-body">
                <?php echo form_open('income/pay' .$e->id) ?>
                <label>Enter Transaction Detail</label>
                <input type="hidden" name="payid" value="" id="payid">
                <textarea type="hidden" class="form-control" name="tdetail"></textarea>
               
               
            </div>
            <div class="modal-footer">
                <button type="submit" class="btn btn-sm Payout Detailuccess">Pay Now</button>
