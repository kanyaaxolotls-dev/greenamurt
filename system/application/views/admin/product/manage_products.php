                ...
                <tbody>
                    ...
                    foreach ($prod as $e) { ?> 
                        <tr>
                            ...
                            <td><?php echo config_item('currency') . " " . $this->common_model->filter($e['dealer_price'] + ($e['dealer_price'] * $e['gst'] / 100), 'decimal'); ?></td>
                            <td>
                            ...
                            <td>
                                ...
                                <a onclick="return confirm('Are you sure you want to delete this Product ?')" href="<?php echo site_url('product/remove/' . $e['id']); ?>">
                                    <img src="https://img.icons8.com/color/20/000000/clear-symbol.png">
                                 </a>
                            </td>
                        </tr>
                    <?php } ?>
