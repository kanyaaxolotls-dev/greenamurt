                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">User-tree</li>
                                        </ol>
                                    </div>
                                ...
                                <div class="col-12">
                                        <div class=" bg-white"  >
                                                ...
                                                <div class="card-header">
                                                         <div class="row mb-2">
                                                            <div class="col-sm-4">
                                                                <h4 class="card-title">My Tree View Team</h4>
                                                                <p class="card-title-desc">This is my Tree View team list</p>
                                                            </div>
                                                            <div class="col-sm-8">
                                                            ...
                                                            <div class="col-sm-12 my-3">
                                                                <form method="POST" action="<?= base_url('tree/my-tree/'); ?>">
                                                                    <input type="text" placeholder="Enter Userid" class="form-control my-2" name="top_id"/>
                                                                    <button type="submit" class="form-control btn-primary">Submit</button>
                                                                    <a href="<?= base_url('member/update_legs'); ?>" class="btn w-100 mt-3 btn-info">Calculate pair</a>
                                                                </form>
                                                            </div>
                                                        </div>
                                                    </div>
                                                                ...
                                                                <?php if (config_item('leg') == "1") { ?>
                                                                    ...
                                                                    <div class="table-responsive">
                                                                            ...
                                                                            <thead class="thead-light">
                                                                                <tr>
                                                                                    <td colspan="3"> <?php $U = $this->plan_model->create_tree($top_id);
                                                                                        echo $U['data'] ?></td>
                                                                                </tr>
                                                                            </thead>
                                                                            <?php
                                                                  ...
                                                                  <?php if (config_item('leg') == "2") { ?>
                                                                     ...
                                                                     <div class="table-responsive bg-white">
                                                                                ...
                                                                                <tr> 
                                                                                    ...
                                                                                    <td colspan="4"
                                                                                        align="center" class='text-dark'><?php $B = $this->plan_model->create_tree($U['B'], $U['id'], 'B');
                                                                                ...
                                                                                <tr>
                                                                                    <td colspan="2"
                                                                                        align="center" class='text-dark'><?php $A_1 = $this->plan_model->create_tree($A['A'], $A['id'], 'A');
                                                                                        echo $A_1['data'].$A_1['id'] ?><br/><img src="<?php echo base_url('uploads/site_img/line_sm.gif') ?>" class="img-responsive" style="width: 80%;">

                                                                                    </td>
                                                                                    <td colspan="2"
                                                                                        align="center" class='text-dark'><?php $A_2 = $this->plan_model->create_tree($A['B'], $A['id'], 'B');
                                                                                        echo $A_2['data'].$A_2['id'] ?><br/><img src="<?php echo base_url('uploads/site_img/line_sm.gif') ?>" class="img-responsive" style="width: 80%;">
                                                                                    </td>
                                                                                    <td colspan="2"
                                                                                        align="center" class='text-dark'><?php $B_1 = $this->plan_model->create_tree($B['A'], $B['id'], 'A');
                                                                                        echo $B_1['data'].$B_1['id'] ?><br/><img src="<?php echo base_url('uploads/site_img/line_sm.gif') ?>"
                                                                                                                      class="img-responsive" style="width: 80%;">
                                                                                    </td>
                                                                                    <td colspan="2"
                                                                                        align="center" class='text-dark'><?php $B_2 = $this->plan_model->create_tree($B['B'], $B['id'], 'B');
                                                                                        echo $B_2['data'].$B_2['id'] ?><br/><img src="<?php echo base_url('uploads/site_img/line_sm.gif') ?>"
                                                                                                                      class="img-responsive" style="width: 80%;">
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="left" class='text-dark'><?php $A1_1 = $this->plan_model->create_tree($A_1['A'], $A_1['id'], 'A');
                                                                                        echo $A1_1['data'].$A1_1['id'] ?></td>
                                                                                    <td align="right" class='text-dark'><?php $A1_2 = $this->plan_model->create_tree($A_1['B'], $A_1['id'], 'B');
                                                                                        echo $A1_2['data'].$A1_2['id']?></td>
                                                                                    <td align="left" class='text-dark'><?php $A2_1 = $this->plan_model->create_tree($A_2['A'], $A_2['id'], 'A');
                                                                                        echo $A2_1['data'].$A2_1['id']?></td>
                                                                                    <td align="right" class='text-dark'><?php $A2_2 = $this->plan_model->create_tree($A_2['B'], $A_2['id'], 'B');
                                                                                        echo $A2_2['data'].$A2_2['id'] ?></td>
                                                                                    <td align="left" class='text-dark'><?php $B1_1 = $this->plan_model->create_tree($B_1['A'], $B_1['id'], 'A');
                                                                                        echo $B1_1['data'].$B1_1['id'] ?></td>
                                                                                    <td align="right" class='text-dark'><?php $B1_2 = $this->plan_model->create_tree($B_1['B'], $B_1['id'], 'B');
                                                                                        echo $B1_2['data'].$B1_2['id'] ?></td>
                                                                                    <td align="left" class='text-dark'><?php $B2_1 = $this->plan_model->create_tree($B_2['A'], $B_2['id'], 'A');
                                                                                        echo $B2_1['data'].$B2_1['id'] ?></td>
                                                                                    <td align="right" class='text-dark'><?php $B2_2 = $this->plan_model->create_tree($B_2['B'], $B_2['id'], 'B');
