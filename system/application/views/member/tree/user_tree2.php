                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">RAJLAXMI Tree</h4>
                                                ...
                                                <div class="card-header">
                                                         <div class="row mb-2">
                                                            <div class="col-sm-4">
                                                                ...
                                                                <p class="card-title-desc">This is my Tree View of team who complete 45 or more pairs </p>
                                                            </div>
                                                            <div class="col-sm-8">
                                                                ...
                                                                <?php if (config_item('leg') == "1") { ?>
                                                                    ...
                                                                    <div class="table-responsive">
                                                                            ...
                                                                            <thead class="thead-light">
                                                                                <tr>
                                                                                    <td colspan="3"> <?php $U = $this->plan_model->create_tree2($top_id);
                                                                                        echo $U['data'] ?></td>
                                                                                </tr>
                                                                            </thead>
                                                                            <?php
                                                                     ...
                                                                     <div class="table-responsive bg-white">
                                                                                ...
                                                                                <tr>
                                                                                    <td colspan="8" align="center" class="text-dark">
                                                                                         ...
                                                                                         <?php } ?><br>
                                                                                        <?php $U = $this->plan_model->create_tree2($top_id);
                                                                                        echo $U['data'].$U['id'] ?>
                                                                                ...
                                                                                <tr> 
                                                                                    <td colspan="4"
                                                                                        ...
                                                                                        <?php $A = $this->plan_model->create_tree2($U['A'], $U['id'], 'A');
                                                                                        echo $A['data'].$A['id'] ?><br/><img src="<?php echo base_url('uploads/site_img/line_sm.gif') ?>"class="img-responsive" style="width: 50%;">
                                                                                    </td>
                                                                                    <td colspan="4"
                                                                                        align="center" class='text-dark'><?php $B = $this->plan_model->create_tree2($U['B'], $U['id'], 'B');
                                                                                ...
                                                                                <tr>
                                                                                    <td colspan="2"
                                                                                        align="center" class='text-dark'><?php $A_1 = $this->plan_model->create_tree2($A['A'], $A['id'], 'A');
                                                                                        echo $A_1['data'].$A_1['id'] ?><br/><img src="<?php echo base_url('uploads/site_img/line_sm.gif') ?>" class="img-responsive" style="width: 80%;">

                                                                                    </td>
                                                                                    <td colspan="2"
                                                                                        align="center" class='text-dark'><?php $A_2 = $this->plan_model->create_tree2($A['B'], $A['id'], 'B');
                                                                                        echo $A_2['data'].$A_2['id'] ?><br/><img src="<?php echo base_url('uploads/site_img/line_sm.gif') ?>" class="img-responsive" style="width: 80%;">
                                                                                    </td>
                                                                                    <td colspan="2"
                                                                                        align="center" class='text-dark'><?php $B_1 = $this->plan_model->create_tree2($B['A'], $B['id'], 'A');
                                                                                        echo $B_1['data'].$B_1['id'] ?><br/><img src="<?php echo base_url('uploads/site_img/line_sm.gif') ?>"
                                                                                                                      class="img-responsive" style="width: 80%;">
                                                                                    </td>
                                                                                    <td colspan="2"
                                                                                        align="center" class='text-dark'><?php $B_2 = $this->plan_model->create_tree2($B['B'], $B['id'], 'B');
                                                                                        echo $B_2['data'].$B_2['id'] ?><br/><img src="<?php echo base_url('uploads/site_img/line_sm.gif') ?>"
                                                                                                                      class="img-responsive" style="width: 80%;">
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="left" class='text-dark'><?php $A1_1 = $this->plan_model->create_tree2($A_1['A'], $A_1['id'], 'A');
                                                                                        echo $A1_1['data'].$A1_1['id'] ?></td>
                                                                                    <td align="right" class='text-dark'><?php $A1_2 = $this->plan_model->create_tree2($A_1['B'], $A_1['id'], 'B');
                                                                                        echo $A1_2['data'].$A1_2['id']?></td>
                                                                                    <td align="left" class='text-dark'><?php $A2_1 = $this->plan_model->create_tree2($A_2['A'], $A_2['id'], 'A');
                                                                                        echo $A2_1['data'].$A2_1['id']?></td>
                                                                                    <td align="right" class='text-dark'><?php $A2_2 = $this->plan_model->create_tree2($A_2['B'], $A_2['id'], 'B');
                                                                                        echo $A2_2['data'].$A2_2['id'] ?></td>
                                                                                    <td align="left" class='text-dark'><?php $B1_1 = $this->plan_model->create_tree2($B_1['A'], $B_1['id'], 'A');
                                                                                        echo $B1_1['data'].$B1_1['id'] ?></td>
                                                                                    <td align="right" class='text-dark'><?php $B1_2 = $this->plan_model->create_tree2($B_1['B'], $B_1['id'], 'B');
                                                                                        echo $B1_2['data'].$B1_2['id'] ?></td>
                                                                                    <td align="left" class='text-dark'><?php $B2_1 = $this->plan_model->create_tree2($B_2['A'], $B_2['id'], 'A');
                                                                                        echo $B2_1['data'].$B2_1['id'] ?></td>
                                                                                    <td align="right" class='text-dark'><?php $B2_2 = $this->plan_model->create_tree2($B_2['B'], $B_2['id'], 'B');
