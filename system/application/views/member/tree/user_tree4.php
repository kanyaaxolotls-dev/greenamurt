                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">RAJKIRTI Tree</h4>
                                                                ...
                                                                <?php if (config_item('leg') == "1") { ?>
                                                                    ...
                                                                    <div class="table-responsive">
                                                                            ...
                                                                            <thead class="thead-light">
                                                                                <tr>
                                                                                    <td colspan="3"> <?php $U = $this->plan_model->create_tree4($top_id);
                                                                                        echo $U['data'] ?></td>
                                                                                </tr>
                                                                            </thead>
                                                                            <?php
                                                                     ...
                                                                     <div class="table-responsive bg-white">
                                                                                ...
                                                                                <tr>
                                                                                    <td colspan="8" align="center" class="text-dark">
                                                                                         ...
                                                                                         <?php } ?><br>
                                                                                        <?php $U = $this->plan_model->create_tree4($top_id);
                                                                                        echo $U['data'].$U['id'] ?>
                                                                                ...
                                                                                <tr> 
                                                                                    <td colspan="4"
                                                                                        ...
                                                                                        <?php $A = $this->plan_model->create_tree4($U['A'], $U['id'], 'A');
                                                                                        echo $A['data'].$A['id'] ?><br/><img src="<?php echo base_url('uploads/site_img/line_sm.gif') ?>"class="img-responsive" style="width: 50%;">
                                                                                    </td>
                                                                                    <td colspan="4"
                                                                                        align="center" class='text-dark'><?php $B = $this->plan_model->create_tree4($U['B'], $U['id'], 'B');
                                                                                ...
                                                                                <tr>
                                                                                    <td colspan="2"
                                                                                        align="center" class='text-dark'><?php $A_1 = $this->plan_model->create_tree4($A['A'], $A['id'], 'A');
                                                                                        echo $A_1['data'].$A_1['id'] ?><br/><img src="<?php echo base_url('uploads/site_img/line_sm.gif') ?>" class="img-responsive" style="width: 80%;">

                                                                                    </td>
                                                                                    <td colspan="2"
                                                                                        align="center" class='text-dark'><?php $A_2 = $this->plan_model->create_tree4($A['B'], $A['id'], 'B');
                                                                                        echo $A_2['data'].$A_2['id'] ?><br/><img src="<?php echo base_url('uploads/site_img/line_sm.gif') ?>" class="img-responsive" style="width: 80%;">
                                                                                    </td>
                                                                                    <td colspan="2"
                                                                                        align="center" class='text-dark'><?php $B_1 = $this->plan_model->create_tree4($B['A'], $B['id'], 'A');
                                                                                        echo $B_1['data'].$B_1['id'] ?><br/><img src="<?php echo base_url('uploads/site_img/line_sm.gif') ?>"
                                                                                                                      class="img-responsive" style="width: 80%;">
                                                                                    </td>
                                                                                    <td colspan="2"
                                                                                        align="center" class='text-dark'><?php $B_2 = $this->plan_model->create_tree4($B['B'], $B['id'], 'B');
                                                                                        echo $B_2['data'].$B_2['id'] ?><br/><img src="<?php echo base_url('uploads/site_img/line_sm.gif') ?>"
                                                                                                                      class="img-responsive" style="width: 80%;">
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="left" class='text-dark'><?php $A1_1 = $this->plan_model->create_tree4($A_1['A'], $A_1['id'], 'A');
                                                                                        echo $A1_1['data'].$A1_1['id'] ?></td>
                                                                                    <td align="right" class='text-dark'><?php $A1_2 = $this->plan_model->create_tree4($A_1['B'], $A_1['id'], 'B');
                                                                                        echo $A1_2['data'].$A1_2['id']?></td>
                                                                                    <td align="left" class='text-dark'><?php $A2_1 = $this->plan_model->create_tree4($A_2['A'], $A_2['id'], 'A');
                                                                                        echo $A2_1['data'].$A2_1['id']?></td>
                                                                                    <td align="right" class='text-dark'><?php $A2_2 = $this->plan_model->create_tree4($A_2['B'], $A_2['id'], 'B');
                                                                                        echo $A2_2['data'].$A2_2['id'] ?></td>
                                                                                    <td align="left" class='text-dark'><?php $B1_1 = $this->plan_model->create_tree4($B_1['A'], $B_1['id'], 'A');
                                                                                        echo $B1_1['data'].$B1_1['id'] ?></td>
                                                                                    <td align="right" class='text-dark'><?php $B1_2 = $this->plan_model->create_tree4($B_1['B'], $B_1['id'], 'B');
                                                                                        echo $B1_2['data'].$B1_2['id'] ?></td>
                                                                                    <td align="left" class='text-dark'><?php $B2_1 = $this->plan_model->create_tree4($B_2['A'], $B_2['id'], 'A');
                                                                                        echo $B2_1['data'].$B2_1['id'] ?></td>
                                                                                    <td align="right" class='text-dark'><?php $B2_2 = $this->plan_model->create_tree4($B_2['B'], $B_2['id'], 'B');
                                                                 ...
                                                                 <?php if (config_item('leg') == "3") { ?>
                                                                    <div class="col-sm-12">
                                                                        <div class="table-responsive">
                                                                                ...
                                                                                <thead class="thead-light">
                                                                                <tr>
                                                                                    <td colspan="9" align="center"><?php $U = $this->plan_model->create_tree4($top_id);
                                                                                ...
                                                                                <tr>
                                                                                    <td colspan="3"
                                                                                        align="center"><?php $A = $this->plan_model->create_tree4($U['A'], $U['id'], 'A');
                                                                                        echo $A['data'].$A['id'] ?><br/><img src="<?php echo base_url('uploads/site_img/line_sm.gif') ?>"
                                                                                                                    class="img-responsive">
                                                                                    </td>
                                                                                    <td colspan="3"
                                                                                        align="center"><?php $B = $this->plan_model->create_tree4($U['B'], $U['id'], 'B');
                                                                                        echo $B['data'].$B['id'] ?><br/><img src="<?php echo base_url('uploads/site_img/line_sm.gif') ?>"
                                                                                                                    class="img-responsive">
                                                                                    </td>
                                                                                    <td colspan="3"
                                                                                        align="center"><?php $C = $this->plan_model->create_tree4($U['C'], $U['id'], 'C');
                                                                                ...
                                                                                <tr>
                                                                                    <td colspan="1"
                                                                                        align="left"><?php $A_1 = $this->plan_model->create_tree4($A['A'], $A['id'], 'A');
                                                                                        echo $A_1['data'].$A_1['id'] ?><br/>
                                                                                    </td>
                                                                                    <td colspan="1"
                                                                                        align="center"><?php $A_2 = $this->plan_model->create_tree4($A['B'], $A['id'], 'B');
                                                                                        echo $A_2['data'].$A_2['id'] ?><br/>
                                                                                    </td>
                                                                                    <td colspan="1"
                                                                                        align="right"><?php $A_3 = $this->plan_model->create_tree4($A['C'], $A['id'], 'C');
                                                                                        echo $A_3['data'].$A_3['id'] ?><br/>
                                                                                    </td>
                                                                                    <td colspan="1"
                                                                                        align="left"><?php $B_1 = $this->plan_model->create_tree4($B['A'], $B['id'], 'A');
                                                                                        echo $B_1['data'].$B_1['id'] ?><br/>
                                                                                    </td>
                                                                                    <td colspan="1"
                                                                                        align="center"><?php $B_2 = $this->plan_model->create_tree4($B['B'], $B['id'], 'B');
                                                                                        echo $B_2['data'].$B_2['id'] ?><br/>
                                                                                    </td>
                                                                                    <td colspan="1"
                                                                                        align="right"><?php $B_3 = $this->plan_model->create_tree4($B['C'], $B['id'], 'C');
                                                                                        echo $B_3['data'].$B_3['id'] ?><br/>
                                                                                    </td>
                                                                                    <td colspan="1"
                                                                                        align="left"><?php $C_1 = $this->plan_model->create_tree4($C['A'], $C['id'], 'A');
                                                                                        echo $C_1['data'].$C_1['id'] ?><br/>
                                                                                    </td>
                                                                                    <td colspan="1"
                                                                                        align="center"><?php $C_2 = $this->plan_model->create_tree4($C['B'], $C['id'], 'B');
                                                                                        echo $C_2['data'].$C_2['id'] ?><br/>
                                                                                    </td>
                                                                                    <td colspan="1"
                                                                                        align="right"><?php $C_3 = $this->plan_model->create_tree4($C['C'], $C['id'], 'C');
                                                                 ...
                                                                 <?php if (config_item('leg') == "4") { ?>
                                                                        <div class="col-sm-12">
                                                                            <div class="table-responsive">
                                                                                    ...
                                                                                    <tbody>
                                                                                    <tr>
                                                                                        <td colspan="16" align="center"><?php $U = $this->plan_model->create_tree4($top_id);
                                                                                            echo $U['data'].$U['id']  ?><br/><img src="<?php echo base_url('uploads/site_img/line_bg.gif') ?>"
                                                                                                                        class="img-responsive">
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        ...
                                                                                        <td colspan="4"
                                                                                            align="center"><?php $D = $this->plan_model->create_tree4($U['D'], $U['id'], 'D');
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td colspan="1"
                                                                                            align="center"><?php $A_3 = $this->plan_model->create_tree4($A['C'], $A['id'], 'C');
                                                                                            echo $A_3['data'].$A_3['id'] ?><br/>
                                                                                        </td>
                                                                                        <td colspan="1"
                                                                                            align="right"><?php $A_4 = $this->plan_model->create_tree4($A['D'], $A['id'], 'D');
                                                                                        ...
                                                                                        <td colspan="1"
                                                                                            align="center"><?php $B_3 = $this->plan_model->create_tree4($B['C'], $B['id'], 'C');
                                                                                            echo $B_3['data'].$B_3['id'] ?><br/>
                                                                                        </td>
                                                                                        <td colspan="1"
                                                                                            align="right"><?php $B_4 = $this->plan_model->create_tree4($B['D'], $B['id'], 'D');
                                                                                        ...
                                                                                        <td colspan="1"
                                                                                            align="center"><?php $C_3 = $this->plan_model->create_tree4($C['C'], $C['id'], 'C');
                                                                                            echo $C_3['data'].$C_3['id'] ?><br/>
                                                                                        </td>
                                                                                        <td colspan="1"
                                                                                            align="right"><?php $C_4 = $this->plan_model->create_tree4($C['D'], $C['id'], 'D');
                                                                                            echo $C_4['data'].$C_4['id'] ?><br/>
                                                                                        </td>

                                                                                        <td colspan="1"
                                                                                            align="left"><?php $D_1 = $this->plan_model->create_tree4($D['A'], $D['id'], 'A');
                                                                                            echo $D_1['data'].$D_1['id'] ?><br/>
                                                                                        </td>
                                                                                        <td colspan="1"
                                                                                            align="center"><?php $D_2 = $this->plan_model->create_tree4($D['B'], $D['id'], 'B');
                                                                                            echo $D_2['data'].$D_2['id'] ?><br/>
                                                                                        </td>
                                                                                        <td colspan="1"
                                                                                            align="center"><?php $D_3 = $this->plan_model->create_tree4($D['C'], $D['id'], 'C');
                                                                                            echo $D_3['data'].$D_3['id'] ?><br/>
                                                                                        </td>
                                                                                        <td colspan="1"
                                                                                            align="right"><?php $D_4 = $this->plan_model->create_tree4($D['D'], $D['id'], 'D');
                                                                      ...
                                                                      <?php if (config_item('leg') == "5") { ?>
                                                                        <div class="col-sm-12">
                                                                            <div class="table-responsive">
                                                                                    ...
                                                                                    <tbody>
                                                                                    <tr>
                                                                                        <td colspan="20" align="center"><?php $U = $this->plan_model->create_tree4($top_id);
                                                                                            echo $U['data'].$U['id']  ?><br/><img src="<?php echo base_url('uploads/site_img/line_bg.gif') ?>"
                                                                                                                        class="img-responsive">
                                                                                        </td>
                                                                                    </tr> 
                                                                                    <tr>
                                                                                        ...
                                                                                        <td colspan="4"
                                                                                            align="center"><?php $E = $this->plan_model->create_tree4($U['E'], $U['id'], 'E');
                                                                                            echo $E['data'].$E['id']  ?><br/>
                                                                                        </td>
                                                                                    </tr>
                                                                                    </tbody>
