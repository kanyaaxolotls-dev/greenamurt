   ...
   <ul class="nav align-items-center d-md-none">
      ...
      <!-- Collapse -->
       ...
       <!--     <li class="nav-item">
          ...
          <?php if (config_item('enable_upgrade') == "No"){ ?>
             ...
             <div class="col-xl-3 col-6 col-md-6">
              <div class="card card-stats mb-4 mb-xl-0 dashboard-card">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-12">
                      <h5 class="card-title text-uppercase text-white mb-0">Level Income </h5>
                   ...
                   <div class="row">
                    <div class="col-12">
                       <span class="h2 font-weight-bold mb-0 text-white"> 
                        <?php 
                          $d = $this->db_model->sum('amount','earning', array('userid' => $this->session->user_id,'type'=>'Level Income'));
                          if($d!=''){
            ...
            <div class="card-header border-0">
              <div class="row align-items-center">
                ...
                <div class="col text-right">
                  <a href="<?php echo site_url('member/view-earning') ?>" class="btn btn-sm btn-primary">See all</a>
                </div>
              </div> 
            <br>
            <?php
                      ...
                      ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="signup_package"
                                            ...
                                            <?php  
                                                $this->db->select('id,prod_name,prod_price')->from('product')->where('id',1);
                  ...
                  $data = $this->db_model->select_multi('signup_package,join_time', 'member', array('id' => $this->session->user_id)); ?>
                    ...
                    <div class="card-body">
                        <?php 
                              ...
                              <p>
                                <?php 
                               $balance=$this->db_model->select('balance', 'product_wallet', array('userid'=> $this->session->user_id));
                               if($balance !=null){
                                  echo '<h3 class="btn btn-success btn-block">Shopping Copoun: <i class="fa fa-inr"></i> '. $balance.'</h3>';
                               }
        ...
        <div class="row">
          <div class="col-xl-6">
            <div class="copyright text-xl-left">
              &copy; 2021 <a href="<?php echo config_item('siteurl') ?>" class="font-weight-bold ml-1 text-white" target="_blank"><?php echo config_item('company_name') ?></a>
            </div>
          </div> 
          <div class="col-xl-6">
