...
<div class="row">
    ...
    <input type="text" required class="form-control" name="bank_ac_no"
      ...
      <?php }else{ ?>
        <input readonly type="text" class="form-control" name="bank_ac_no"
           value="<?php echo set_value('bank_ac_no', $data->bank_ac_no) ?>">
           <?php } ?>
    </div>
     <div class="col-md-4 col-sm-12">
    ...
    <input required type="text" class="form-control" name="bank_ifsc"
           ...
           <?php }else{ ?>
            <input readonly type="text" class="form-control" name="bank_ifsc"
           value="<?php echo set_value('bank_ifsc', $data->bank_ifsc) ?>">  
           <?php } ?>
    </div>
</div>
...
<div class="ccol-md-6 col-sm-6 col-xs-12"><label>Address Proof:</label><br>
...
<br>
<div class="col-md-6 col-sm-6 col-xs-12"><label>Id proof:</label> <br>
